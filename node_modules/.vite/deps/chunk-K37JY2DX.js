...
function Ce(r4, e, t, i = "brackets") {
  ...
  return r4 === "get" && Object.keys(t).length && (a.search = B.stringify(mergeWith(B.parse(a.search, { ignoreQueryPrefix: true }), t, (h, c, b, x) => {
    c === void 0 && delete x[b];
...
var H = class r2 {
  ...
  mergeProps(e) {
    ...
    t.forEach((o) => {
      ...
      let u = e.props[o], p = n.get().props[o], d = (a, h, c) => Array.isArray(h) ? this.mergeOrMatchItems(a, h, c, s) : typeof h == "object" && h !== null ? Object.keys(h).reduce((b, x) => (b[x] = d(a ? a[x] : void 0, h[x], `${c}.${x}`), b), { ...a }) : h;
      e.props[o] = d(p, u, o);
...
function Oe(r4, e, t) {
  ...
  function a() {
    let c = e(""), b = { ...c ? { title: `<title inertia="">${c}</title>` } : {} }, x = Object.values(i).reduce((R, T) => R.concat(T), []).reduce((R, T) => {
...
@inertiajs/core/dist/index.esm.js:
   ...
   * @license MIT *)
*/
//# sourceMappingURL=chunk-K37JY2DX.js.map
