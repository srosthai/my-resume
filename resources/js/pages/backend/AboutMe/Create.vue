    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="space-y-6 p-4">
            <div>
                ...
                <p class="text-sm text-muted-foreground">Add new about me information</p>
            </div>

            <Card>
                <CardHeader>
                    <CardTitle>About Me Information</CardTitle>
                    <CardDescription> Enter your personal and professional details below </CardDescription>
                </CardHeader>
                <CardContent>
