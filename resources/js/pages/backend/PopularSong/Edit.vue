        ...
        <div class="mx-auto w-full max-w-3xl space-y-8 p-4 sm:p-6">
            ...
            <div class="flex items-center gap-4">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h1 class="text-2xl font-semibold tracking-tight">Edit Song</h1>
                        <p class="text-sm text-muted-foreground">Update the song information in your music library</p>
                    </div>
                </div>
            </div>
                ...
                <div class="rounded-2xl border bg-card shadow-sm">
                    <div class="space-y-6 p-6 sm:p-8">
                        ...
                        <div class="rounded-lg bg-muted p-4">
                            <h4 class="mb-2 font-medium">Current Song</h4>
                        ...
                        <div v-if="form.url && form.title" class="rounded-lg bg-muted p-4">
                            <h4 class="mb-2 font-medium">Updated Preview</h4>
                            <div class="flex items-center gap-3">
                                <div class="flex size-10 items-center justify-center rounded-lg bg-primary/10">
                                    <Icon name="music" class="size-5 text-primary" />
                                </div>
